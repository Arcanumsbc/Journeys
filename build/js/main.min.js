...
var _initSlider = require("./vendor/init-slider");
var _iframe = require("./vendor/iframe");
var _burger = require("./modules/menu/burger");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  window.addEventListener('load', function () {
    ...
    burger.init();
    (0, _initSlider.initHeroSlider)();
    (0, _initSlider.initToursSlider)();
    (0, _initSlider.initInstructorsSlider)();
    (0, _iframe.addVideoPlayer)();
    (0, _iframe.addAudioPlayer)();
    (0, _initSlider.initRewiewsSlider)();
    (0, _initSlider.initAdvantagesSlider)();
    (0, _initSlider.initGallerySlider)();
...
},{"./modules/form-validate/form":3,"./modules/map/map":9,"./modules/menu/burger":10,"./modules/modals/init-modals":11,"./utils/ios-vh-fix":15,"./vendor/iframe":18,"./vendor/init-slider":19}],2:[function(require,module,exports){
"use strict";
...
var initContactsMap = function initContactsMap() {
  if (document.querySelector('#map')) {
    ...
    var coordinate = [55.774888415546656, 37.632586886490785];
...
},{"../../vendor/leaflet":20}],10:[function(require,module,exports){
"use strict";
...
function _toPropertyKey(arg) { var key = _toPrimitive(arg, "string"); return _typeof(key) === "symbol" ? key : String(key); }
function _toPrimitive(input, hint) { if (_typeof(input) !== "object" || input === null) return input; var prim = input[Symbol.toPrimitive]; if (prim !== undefined) { var res = prim.call(input, hint || "default"); if (_typeof(res) !== "object") return res; throw new TypeError("@@toPrimitive must return a primitive value."); } return (hint === "string" ? String : Number)(input); }
var navMain = document.querySelector('.main-header__menu');
...
},{"../../utils/focus-lock":13,"../../utils/scroll-lock":17}],11:[function(require,module,exports){
"use strict";
...
exports.addVideoPlayer = exports.addAudioPlayer = void 0;
// iframe
// iframe video
...
var addVideoPlayer = function addVideoPlayer() {
...
exports.addVideoPlayer = addVideoPlayer;
var addAudioPlayer = function addAudioPlayer() {
  if (document.querySelector('.audio')) {
    var wrapper = document.querySelector('.audio');
    var button = wrapper.querySelector('.audio__play');
...
exports.initToursSlider = exports.initRewiewsSlider = exports.initInstructorsSlider = exports.initHeroSlider = exports.initGallerySlider = exports.initAdvantagesSlider = void 0;
var _isMobile = require("../utils/is-mobile");
var initHeroSlider = function initHeroSlider() {
  var heroContainer = document.querySelector('.hero__slider');
  var heroControl = document.querySelector('.hero__control');
  heroControl.removeAttribute('data-nojs');
  var heroSlider = new Swiper(heroContainer, {
...
var initToursSlider = function initToursSlider() {
  var toursContainer = document.querySelector('.tours__slider');
  var toursControl = document.querySelector('.tours__arrows');
  toursControl.removeAttribute('data-nojs');
  var tourslider = new Swiper(toursContainer, {
    allowTouchMove: (0, _isMobile.isMobile)(),
    initialslide: 0,
    speed: 300,
    loop: false,
...
exports.initToursSlider = initToursSlider;
var initInstructorsSlider = function initInstructorsSlider() {
  var instructorsContainer = document.querySelector('.instructors__slider');
  var instructorsControl = document.querySelector('.instructors__arrows');
  instructorsControl.removeAttribute('data-nojs');
  var instructorsSlider = new Swiper(instructorsContainer, {
    allowTouchMove: (0, _isMobile.isMobile)(),
    initialslide: 0,
    speed: 300,
    loop: false,
...
exports.initInstructorsSlider = initInstructorsSlider;
var initRewiewsSlider = function initRewiewsSlider() {
  var rewiewsContainer = document.querySelector('.rewiews__slider');
  var rewiewsControl = document.querySelector('.rewiews__arrows');
  rewiewsControl.removeAttribute('data-nojs');
  var rewiewsSlider = new Swiper(rewiewsContainer, {
    allowTouchMove: (0, _isMobile.isMobile)(),
    slidesPerView: 'auto',
    initialslide: 2,
    autoHeight: true,
...
exports.initRewiewsSlider = initRewiewsSlider;
var initAdvantagesSlider = function initAdvantagesSlider() {
  var advantagesContainer = document.querySelector('.advantages__slider');
  var advantagesControl = document.querySelector('.advantages__arrows');
  ...
  var advantagesCreateSlider = function advantagesCreateSlider() {
    var swiper = null;
...
exports.initAdvantagesSlider = initAdvantagesSlider;
var initGallerySlider = function initGallerySlider() {
  var galleryContainer = document.querySelector('.gallery__slider');
  var galleryControl = document.querySelector('.gallery__arrows');
  galleryControl.removeAttribute('data-nojs');
  var gallerySlider = new Swiper(galleryContainer, {
    allowTouchMove: (0, _isMobile.isMobile)(),
    slidesPerView: 'auto',
    loop: true,
    spaceBetween: 5,
...
},{"../utils/is-mobile":16}],20:[function(require,module,exports){
"use strict";
