...
},{"./modules/form-validate/form":3,"./modules/menu/burger":9,"./modules/modals/init-modals":10,"./utils/ios-vh-fix":14,"./vendor/iframe":16,"./vendor/init-slider":17}],2:[function(require,module,exports){
"use strict";
...
},{"../../utils/focus-lock":12,"../../utils/scroll-lock":15}],10:[function(require,module,exports){
"use strict";
...
var setupVideo = function setupVideo(video) {
  ...
  var media = video.querySelector('img');
  var button = video.querySelector('button');
  var wrapper = video.querySelector('.hero__media-wrapper');
...
var videoIntro = document.querySelector('.hero__media');
